...
<body>
    ...
    <div class="container mt-5"> 
            ...
            <div class="card" style="width: 22rem;">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">BATCH: 
                        <?php 
                            $batch = $student['batch'];
                            $g = getBatchById($batch, $conn);
                            if ($g !== 0) {
                                echo $g['batch_code'].'-'.$g['batch'];
                            } else {
                                echo "Batch information not available";
                            }
                        ?>
                    </li>
                    <li class="list-group-item">Section: 
                        <?php 
                            ...
                            if ($s !== 0) {
                                ...
                                echo "Section information not available";
                            }
                        ?>
                    </li>
        ...
        <?php } else { ?>
            <div class="alert alert-danger" role="alert">Student information not found</div>
        <?php } ?>
    </div>
