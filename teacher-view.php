...
if (isset($_SESSION['admin_id']) && 
    ...
    if ($_SESSION['role'] == 'Admin') {
       ...
       include "data/batch.php"; // Changed to "batch.php"
     ...
     <div class="container mt-5">
         <div class="card" style="width: 22rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Batch:
        <?php 
        $c = '';
        ...
        foreach ($classes as $class_id) {
            ...
            $c_temp = getBatchById($class['batch'], $conn); // Changed from "getGradeById" to "getBatchById"
            $section = getSectioById($class['section'], $conn);
            if ($c_temp != 0) 
                $c .= $c_temp['batch_code'].'-'.$c_temp['batch'].', '.$section['section'].''; // Added space between batch and section
        }
        echo $c;
         ?>
          </li>
