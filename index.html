...
<body class="body-home">
    <div class="black-fill"><br /> <br />
			  ...
			  <div class="row g-0">
			    ...
			    <div class="col-md-8">
			      <div class="card-body">
			        ...
			        <p class="card-text"><small class="text-muted">Coaching Management System</small></p>
			      </div>
			    </div>
			  </div>
			</div>
        ...
        <div class="text-center text-light">
        	Copyright &copy;Abid Jafar<?=$setting['current_year']?> <?=$setting['school_name']?>. All rights reserved.
        </div>
